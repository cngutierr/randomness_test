...
all: clean default gen_features
...
gen_features:
	$(C_COMPILER) $(CFLAGS) $(INC_DIRS) $(SYMBOLS) -o bin/gen_features src/3rdparty/cephes.c src/utils.c src/rand_tests.c src/gen_features.c -lm
